...
function App() {
  ...
  const getWeather = async (location) => {
    ...
    try {
      ...
      setLoading(false);
      setNoData("Failed to fetch weather data");
      console.log(error);
    }
  };
  ...
  return (
    <div className="container">
      <div
        ...
        style={{
          background: `${
            weatherData.length > 0 ? BackgroundColor(weatherData) : "#a6ddf0"
          }`,
          top: "-10%",
          right: "0",
        }}
      ...
      <div className="content">
        ...
        <div className="info-container">
          ...
          {city && <h2 className="city-name">{city}</h2>}
